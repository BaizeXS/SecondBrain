            ...
            {agentData.apiProvider === 'default' ? (
              ...
              <div className={styles.customApiFields}>
                <div className={styles.formSubGroup}>
                  ...
                  <input
                    type="text" id="apiEndpoint" name="apiEndpoint"
                    value={agentData.apiEndpoint || ''} onChange={handleChange}
                    className={styles.inputField} placeholder="e.g., https://api.openai.com/v1/chat/completions"
                  />
                </div>
                <div className={styles.formSubGroup}>
                  ...
                  <input
                    ...
                    value={agentData.apiKey || ''} onChange={handleChange}
                    className={styles.inputField} placeholder="Enter your secret API key"
                  />
                </div>
                <div className={styles.formSubGroup}>
                  <label htmlFor="customModelName">Model Name</label>
                  <input
                    type="text" id="customModelName" name="modelName"
                    value={agentData.modelName || ''} onChange={handleChange}
                    className={styles.inputField} placeholder="e.g., gpt-3.5-turbo, claude-2"
                  />
                  <p className={styles.fieldHint}><FiInfo size="0.9em" /> The exact model name required by your API provider.</p>
                </div>
              </div>
            )}
          </div>
