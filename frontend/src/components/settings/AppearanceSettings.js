...
import { FiSun, FiMoon, FiMonitor, FiType, FiSidebar, FiChevronsLeft, FiChevronsRight, FiEye, FiGlobe } from 'react-icons/fi';
  ...
  return (
    <div className={styles.settingsSection}>
      ...
      <div className={styles.sectionContent}>
        ...
        {/* --- 语言选择 --- */}
        <div className={styles.settingGroup}>
          <h4 className={styles.settingTitle}><FiGlobe /> Language</h4>
          <p className={styles.settingDescription}>Select your preferred language for the interface.</p>
          <select
            id="languageSelect"
            value={language}
